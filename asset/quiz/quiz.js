...
let hints = ["Абривиатурата на предмета Чужд език по професията.", "Предмета се използва често по време на пандемия.", "Думата се римува с пек и мек." ,"Предмета е дълъг, пухкав и лъскав.", "Това е място на вечна зима, където полярните светлини озаряват небето, а северните елени са символ на тази магическа област.","Тази част от думата създава срички.", "Превозното средство се предвижва по въздух.","Първото име на президента е Георги.", "Дивеч, с големи рога. Живее на студено и има общи прилики със сърната.","В мястото могат да се съдаят всякакви видове растения и обикновено в нея работи градинар."]; 
...
$(function(){
    ...
    $('#hint-button').on('click', function() { Hint(); });
    QuestionTitleShow();
    QuestionShow();
